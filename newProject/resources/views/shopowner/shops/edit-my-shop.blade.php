...
@section('title', 'แก้ไขข้อมูลร้านค้า')

@section('content')
<div class="container mx-auto">
    <h2 class="text-2xl font-bold mb-6">แก้ไขข้อมูลร้านค้า</h2>

    <div class="bg-white p-6 shadow rounded-lg">
        <form method="POST" action="{{ route('shopowner.shops.update-my-shop', $shop->shop_id) }}" class="max-w-4xl mx-auto">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="shop_location" id="shop_location" rows="3" 
                              class="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500" 
                              required>{{ old('shop_location', $shop->shop_location) }}</textarea>
                </div>
            </div>
